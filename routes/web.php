...
Route::get('/pedidos/{celular}', [App\Http\Controllers\pedidoscontroller::class, 'index']);
...
Route::get('/vueproductoperfil', [App\Http\Controllers\vuecontroller::class, 'vueProductoperfil']);
Route::get('/vueproductoperfilmostrarimagen/{imagen}', [App\Http\Controllers\vuecontroller::class, 'vueProductoperfilmostrarimgen']);
